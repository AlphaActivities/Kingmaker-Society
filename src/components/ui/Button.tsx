...
export default function Button({
  ...
  const baseStyles = 'font-semibold transition-all duration-400 rounded-lg disabled:opacity-50 disabled:cursor-not-allowed relative overflow-hidden group focus:outline-none focus:ring-4 focus:ring-offset-2 focus:ring-offset-[#0B0B0B] transform-gpu active:scale-95';
